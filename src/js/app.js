...
(function() {
    ...
    // Inicializar servicios de damas (touch y click)
    function initDamasServices() {
        const damasCards = utils.getElements('.servicio-card-dama');
        ...
        // Manejar touch en móviles para mostrar "Ver más"
        damasCards.forEach(card => {
            ...
            card.addEventListener('touchstart', (e) => {
                ...
                // Mostrar "Ver más" después de un breve delay
            ...
            card.addEventListener('touchend', (e) => {
                ...
                // Si fue un tap rápido, abrir modal directamente
