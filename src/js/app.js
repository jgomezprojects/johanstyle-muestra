...
(function() {
    ...
    // Utilidades de logging (solo en desarrollo)
    ...
    const utils = {
        ...
        getElement: (selector) => {
            try {
                ...
                error(`Error al obtener elemento ${selector}:`, err);
                return null;
            }
        },
        ...
        getElements: (selector) => {
            try {
                ...
                error(`Error al obtener elementos ${selector}:`, err);
                return [];
            }
        }
    };
    ...
    function init() {
        try {
            ...
            error('Error en la inicialización:', err);
        }
    }
    ...
    function initReviews() {
        ...
        function saveReviewToStorage(reviewData) {
            try {
                ...
                error('Error al guardar review:', err);
            }
        }
        ...
        function loadReviewsFromStorage() {
            try {
                ...
                error('Error al cargar reviews:', err);
            }
        }
    ...
    function initHeroSlider() {
        ...
        function startInterval() {
            ...
            heroInterval = setInterval(nextImage, 5000);
        }
        ...
        // Limpiar intervalo al desmontar (si es necesario)
        return () => {
            stopInterval();
        };
    }
    ...
    function initMobileMenu() {
        ...
        const toggleBodyScroll = (block) => {
            if (block) {
                ...
                // Guardar la posición del scroll antes de bloquear
